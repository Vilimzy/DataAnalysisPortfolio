...
INSERT INTO branch VALUES(4, 'Bufflao', NULL, NULL);
...
------FINDING EMPLOYEES ORDERED BY SALARY
SELECT *
FROM employee
ORDER BY salary
...
---FIND FIRST AND LASTNAME OF EMPLOYEES
SELECT first_name, last_name
FROM employee


------FINDING THE FORENAME AND SURNAMES
...
------FINDING THE AVERAGE OF EMPLOYEE SALARY
...
----FIND OUT NUMBER OF MALES AND FEMALE
...
---- FINDING HOW MUCH EACH CLIENT SPENT
...
SELECT first_name AS Company_List
FROM employee
UNION
SELECT branch_name 
FROM branch 
...
SELECT total_sales
FROM works_with
------FIND A LIST OF MONEY EARNED OR SPENT
